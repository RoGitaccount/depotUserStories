        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-3">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="https://www.instagram.com/" className="group relative" title="Instagram">
              ...
              <a href="https://fr-fr.facebook.com/" className="group relative" title="Facebook">
              ...
              <a href="https://x.com/" className="group relative" title="Twitter/X">
